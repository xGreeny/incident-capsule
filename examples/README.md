...
- `config.privacy-conscious.psd1` suppresses process command lines, Defender preferences, native EVTX export, and high-detail inventories.
- `config.extended.psd1` enables bounded executable hashing, signed-driver inventory, task XML, and a 72-hour event window.
